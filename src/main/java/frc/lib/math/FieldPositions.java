...
public final class FieldPositions {
    ...
    public static final Pose2d BLUE_AMP_POSITION = new Pose2d(1.84, 8.07 - 0.30, Rotation2d.fromDegrees(90.0));
    public static final Pose2d RED_AMP_POSITION = new Pose2d(14.701, 8.07 - 0.30, Rotation2d.fromDegrees(90.0));
}
