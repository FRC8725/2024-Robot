...
public enum RobotCANPorts {
    ...
    LEFT_SHOOTER(14), RIGHT_SHOOTER(15), ANGLETOGGLER(16),
    RIGHT_INTAKE(17),  LEFT_INTAKE(18), RIGTH_INTAKE_LIFTER(19), LEFT_INTAKE_LIFTER(20),
    LEFT_ELEVATOR(21), RIGHT_ELEVATOR(22);
