...
public class AutoTrackNoteCommand extends Command {
    ...
    // TODO transform these stuff into profiled pid and embed them in swerve subsystem
    ...
    @Override
    public void execute() {
        // TODO transform this entire thing into situateRobot(Pose2d, Pose2d)
        ...
        if (rotationSpeed == 0.0 || !this.canSteer) {
            ...
            this.canSteer = false;
        } else this.swerveSubsystem.drive(0.0, 0.0, rotationSpeed, false);
    }
