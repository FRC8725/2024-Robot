...
public class IntakeCommand extends Command {
    ...
    public void execute() {
        ...
        if (lifterDirection < 0) this.intakeSubsystem.liftTo(IntakeSubsystem.LIFTER_MAX_SETPOINT);
        else if (lifterDirection > 0) this.intakeSubsystem.liftTo(IntakeSubsystem.LIFTER_MIN_SETPOINT);
